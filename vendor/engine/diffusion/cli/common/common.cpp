...
ArgOptions SDContextParams::get_options() {
    ...
    options.string_options = {
        ...
        {"",
         "--llm-adapter",
         "path to a Qwen3 -> T5-XXL bridge adapter (lets PixArt run with --llm qwen3-0.6b instead of --t5xxl)",
         0,
         &llm_adapter_path},
        {"",
         "--llm_adapter",
         "alias of --llm-adapter",
         0,
         &llm_adapter_path},
        {"",
         "--qwen2vl",
        ...
        {"",
         "--audio-vae",
         "path to standalone audio VAE model (LTXAV or MiniMax H3)",
         0,
         &audio_vae_path},
        {"",
         "--taesd",
...
ArgOptions SDGenerationParams::get_options() {
    ...
    options.string_options = {
        ...
        {"",
         "--lyrics",
         "lyrics for music models such as MiniMax Music 3 (default: none, instrumental)",
         0,
         &lyrics},
        {"-i",
         "--init-img",
    ...
    options.int_options = {
        {"-H",
         "--height",
         "image height, in pixel space (default: model-specific, usually 512)",
         &height},
        {"-W",
         "--width",
         "image width, in pixel space (default: model-specific, usually 512)",
         &width},
        {"",
         "--steps",
    ...
    options.float_options = {
        {"",
         "--cfg-scale",
         "unconditional guidance scale: (default: model-specific, usually 7.0)",
        ...
        {"",
         "--audio-duration",
         "seconds of audio to generate with audio models such as ACE-Step (default: 60)",
         &audio_duration},
        {"",
         "--vae-tile-overlap",
...
sd_vid_gen_params_t SDGenerationParams::to_sd_vid_gen_params_t() {
    ...
    params.lyrics                    = lyrics.empty() ? nullptr : lyrics.c_str();
