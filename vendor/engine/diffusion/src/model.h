...
static inline bool sd_version_is_lumina2(SDVersion version) {
    return version == VERSION_LUMINA2;
}
...
static inline bool sd_version_is_ace_step(SDVersion version) {
    return version == VERSION_ACE_STEP;
}

static inline bool sd_version_is_minimax_music3(SDVersion version) {
    return version == VERSION_MINIMAX_MUSIC3;
}

static inline bool sd_version_uses_flux_vae(SDVersion version) {
    if (sd_version_is_flux(version) || sd_version_is_z_image(version) || sd_version_is_boogu_image(version) || sd_version_is_longcat(version) || sd_version_is_lumina2(version)) {
        return true;
    }
    return false;
}
...
static inline bool sd_version_uses_minimax_h3_vae(SDVersion version) {
    return sd_version_is_minimax_h3(version);
}
