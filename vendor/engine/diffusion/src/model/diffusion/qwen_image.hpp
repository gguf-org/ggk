...
namespace Qwen {
    ...
    public:
        ...
        QwenImageRunner(ggml_backend_t backend,
            ...
            : QwenImageRunner(backend, tensor_storage_map, prefix, version, false, weight_manager, nullptr) {}
        ...
        QwenImageRunner(ggml_backend_t backend,
                        ...
                        bool zero_cond_t,
                        std::shared_ptr<RunnerWeightManager> weight_manager)
            : QwenImageRunner(backend, tensor_storage_map, prefix, version, zero_cond_t, weight_manager, nullptr) {}
