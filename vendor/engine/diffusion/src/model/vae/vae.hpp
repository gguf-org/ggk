...
public:
    ...
    virtual sd::Tensor<float> encode(int n_threads,
        ...
        if (tiling_params.enabled) {
            ...
            const float encode_tile_factor = (sd_version_is_wan(version) || sd_version_is_hunyuan_video(version) || sd_version_is_ltxav(version) || sd_version_is_minimax_h3(version)) ? 1.30539f : 2.0f;
