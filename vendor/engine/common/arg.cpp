...
static void common_params_print_completion(common_params_context & ctx_arg) {
    ...
    printf("_gguf_server_completions() {\n");
    ...
    for (const auto& exe : executables) {
        printf("complete -F _gguf_server_completions %s\n", exe.c_str());
    }
}
...
common_params_context common_params_parser_init(common_params & params, llama_example ex, void(*print_usage)(int, char **)) {
    ...
    add_opt(common_arg(
        {"--completion-bash"},
        "print source-able bash completion script for gguf-server",
        [](common_params & params) {
    ...
    add_opt(common_arg(
        {"-mm", "--mmproj"}, "FILE",
        "path to a multimodal projector file. see mtmd/README.md\n"
    ...
    add_opt(common_arg(
        {"-mmu", "--mmproj-url"}, "URL",
        "URL to a multimodal projector file. see mtmd/README.md",
        [](common_params & params, const std::string & value) {
    ...
    add_opt(common_arg(
        ...
        [](common_params & params, const std::string & value) {
            ...
            if (!llama_supports_gpu_offload()) {
                ...
                fprintf(stderr, "warning: one possible reason is that gguf-server was compiled without GPU support\n");
                fprintf(stderr, "warning: see README.md for the GGUF_SERVER_CUDA / _HIP / _METAL / _VULKAN build options\n");
            }
        }
    ...
    add_opt(common_arg(
        ...
        [](common_params & params, const std::string & value) {
            ...
            if (!llama_supports_gpu_offload()) {
                fprintf(stderr, "warning: gguf-server was compiled without support for GPU offload. Setting the split mode has no effect.\n");
            }
        }
    ...
    add_opt(common_arg(
        ...
        [](common_params & params, const std::string & value) {
            ...
            if (!llama_supports_gpu_offload()) {
                fprintf(stderr, "warning: gguf-server was compiled without support for GPU offload. Setting a tensor split has no effect.\n");
            }
        }
    ...
    add_opt(common_arg(
        ...
        [](common_params & params, int value) {
            ...
            if (!llama_supports_gpu_offload()) {
                fprintf(stderr, "warning: gguf-server was compiled without support for GPU offload. Setting the main GPU has no effect.\n");
            }
        }
